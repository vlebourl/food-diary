...
public final class FragmentReportsBinding implements ViewBinding {
  ...
  public static FragmentReportsBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.text_reports;
      TextView textReports = ViewBindings.findChildViewById(rootView, id);
      if (textReports == null) {
        break missingId;
      }

      return new FragmentReportsBinding((ConstraintLayout) rootView, textReports);
    }
