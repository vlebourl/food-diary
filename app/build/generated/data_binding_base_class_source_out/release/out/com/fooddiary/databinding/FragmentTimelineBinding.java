...
public final class FragmentTimelineBinding implements ViewBinding {
  ...
  public static FragmentTimelineBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.text_timeline;
      TextView textTimeline = ViewBindings.findChildViewById(rootView, id);
      if (textTimeline == null) {
        break missingId;
      }

      return new FragmentTimelineBinding((ConstraintLayout) rootView, textTimeline);
    }
