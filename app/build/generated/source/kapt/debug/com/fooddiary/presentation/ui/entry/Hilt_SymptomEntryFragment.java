 ...
 */
public abstract class Hilt_SymptomEntryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SymptomEntryFragment() {
    super();
  }

  Hilt_SymptomEntryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SymptomEntryFragment_GeneratedInjector) this.generatedComponent()).injectSymptomEntryFragment(UnsafeCasts.<SymptomEntryFragment>unsafeCast(this));
    }
  }
