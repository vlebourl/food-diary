 ...
 */
public abstract class Hilt_EliminationProtocolFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EliminationProtocolFragment() {
    super();
  }

  Hilt_EliminationProtocolFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EliminationProtocolFragment_GeneratedInjector) this.generatedComponent()).injectEliminationProtocolFragment(UnsafeCasts.<EliminationProtocolFragment>unsafeCast(this));
    }
  }
