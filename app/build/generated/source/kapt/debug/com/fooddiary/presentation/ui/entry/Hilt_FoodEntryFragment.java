 ...
 */
public abstract class Hilt_FoodEntryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FoodEntryFragment() {
    super();
  }

  Hilt_FoodEntryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FoodEntryFragment_GeneratedInjector) this.generatedComponent()).injectFoodEntryFragment(UnsafeCasts.<FoodEntryFragment>unsafeCast(this));
    }
  }
