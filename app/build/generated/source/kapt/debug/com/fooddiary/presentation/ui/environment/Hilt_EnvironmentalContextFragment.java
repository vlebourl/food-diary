 ...
 */
public abstract class Hilt_EnvironmentalContextFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_EnvironmentalContextFragment() {
    super();
  }

  Hilt_EnvironmentalContextFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((EnvironmentalContextFragment_GeneratedInjector) this.generatedComponent()).injectEnvironmentalContextFragment(UnsafeCasts.<EnvironmentalContextFragment>unsafeCast(this));
    }
  }
