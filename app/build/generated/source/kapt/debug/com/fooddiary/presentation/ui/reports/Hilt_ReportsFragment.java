 ...
 */
public abstract class Hilt_ReportsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ReportsFragment() {
    super();
  }

  Hilt_ReportsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ReportsFragment_GeneratedInjector) this.generatedComponent()).injectReportsFragment(UnsafeCasts.<ReportsFragment>unsafeCast(this));
    }
  }
